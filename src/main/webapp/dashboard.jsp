...
<li>  <a href="${pageContext.request.contextPath}/spring/filelist.do?username=${username}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="	fa fa-file-o"></span> 文&nbsp;&nbsp;   件&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
<!-- <li>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;布局实例&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li> -->
   ...
   <ul id="nav">
    ...
    <li class="visible-xs visible-sm last">        
	    <a href="#">
		  ...
		  <a href="${pageContext.request.contextPath}/spring/testlog.do">Imprint</a>
		</a>        
    </li>
</ul>
</div>
...
<div id="main_right">
<div id="content">
 <form enctype="multipart/form-data"><hr><div class="file-loading"><input id="file-4" name="file" type="file" class="file" data-upload-url="${pageContext.request.contextPath}/spring/save-product.do" multiple></div><hr></form>
</div>
</div>
</div>
