...
.upnav{width: 1000px; height:48px; margin: auto;}
...
.container-fluid {margin:20px; width: 100%; height:90px; background:#FFF; }
...
#content {
  min-height:100%;height:auto !important;height:100%;/*ie6不识别min-height,如上述处理*/
  position: absolute;
  margin: 1em;
}
#uppart {
...
<div class="contact-link">
 <div class="buttonCTAItemComponent parbase nav_contact">
  <div class="btn-container ">
	<a role="button" class="btn btn-lg simple-link no-caret salesforce-sans-bold    " href="${pageContext.request.contextPath}/contact.jsp" target="_blank">
...
<div class="footer" data-action-label="Select an action">
<!--  id="fixed-footer" -->
